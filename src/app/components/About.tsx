  ...
  return typeof window !== "undefined" ? (
    <div className="about w-full">
      <div className="about-wrapper mt-12 flex flex-col justify-center items-center lg:flex-row lg:p-20 lg:gap-16">
        <div className="hero-image w-[70%] animate-heroAnimation lg:w-[50%]">
        ...
        <div className="about-content p-6 text-justify text-slate-800 mt-4 ">
          ...
          <h1 className="text-5xl font-bold py-2 text-black transform transition-transform hover:scale-105">
            A N T H I Y A
          </h1>
          <p className=" pt-2">
          ...
          <button className="bg-black text-white p-2 rounded-md mt-6 mb-3 lg:w-[30%] transform transition-transform hover:scale-105">
